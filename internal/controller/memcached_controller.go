...
const memcachedFinalizer = "webapp.my.domain/finalizer"
...
//+kubebuilder:rbac:groups=webapp.my.domain,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=webapp.my.domain,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=webapp.my.domain,resources=memcacheds/finalizers,verbs=update
...
func (r *MemcachedReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	memcached := &webappv1alpha1.Memcached{}
...
func (r *MemcachedReconciler) doFinalizerOperationsForMemcached(cr *webappv1alpha1.Memcached) {
...
func (r *MemcachedReconciler) deploymentForMemcached(
	memcached *webappv1alpha1.Memcached) (*appsv1.Deployment, error) {
